const CACHE='segunda-mente-v9';
const STATE_CACHE='segunda-mente-state-v1';
const PUSH_MARKER='./__push_registered__';
const ASSETS=['./','./index.html','./app.css?v=7','./app-polish.css?v=7','./app.js?v=7','./app-enhance.js?v=7','./gym.css?v=1','./gym-enhance.css?v=1','./gym-body.css?v=1','./gym.js?v=1','./gym-weights.js?v=1','./gym-weights-core.js?v=1','./gym-nav.js?v=1','./gym-body.js?v=1','./activar-notificaciones.html','./manifest.webmanifest','./icon.svg'];
