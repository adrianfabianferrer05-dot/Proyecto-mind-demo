...
const ASSETS=['./','./index.html','./app.css?v=8','./app-polish.css?v=7','./app.js?v=14','./app-enhance.js?v=7','./memory-ui.js?v=1','./gym.css?v=1','./gym-enhance.css?v=2','./gym-body.css?v=2','./memory-ui.css?v=1','./gym.js?v=2','./gym-weights.js?v=2','./week.js?v=1','./week.css?v=1','./today.js?v=2','./today.css?v=1','./gym-weights-core.js?v=1','./gym-nav.js?v=1','./gym-anatomy.js?v=2','./gym-body.js?v=2','./activar-notificaciones.html','./manifest.webmanifest','./icon.svg'];
