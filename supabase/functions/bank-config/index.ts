...
Deno.serve(async(req=>{
  ...
  try{
    ...
    if(!/^[0-9a-f]{8}-[0-9a-f-]{27}$/i.test(appId))return json({ok:false,error:"invalid_app_id",detail:"Revisa el Application ID de Enable Banking."},400);
